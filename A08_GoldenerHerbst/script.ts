namespace Canvas {
    ...
    function handleload (): void {
        ...
        for (let index: number = 0; index < 8; index++) {
            ...
            let scaleNumber: number = 0.1 + Math.random();
    ...
    function drawGinko(_position: Vector, _scale: Vector): void {
    ...
    function drawRoundLeave(_position: Vector, _scale: Vector): void {
    ...
    function drawMaple(_position: Vector, _scale: Vector): void {
    ...
    function drawSquirrel(_position: Vector, _fillColor: string): void {
